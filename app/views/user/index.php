          ...
          <table class="table table-bordered">
                  ...
                  <?php $no=1; ?> 
                    ...
                    <tr>
                      ...
                      <td><?= $row['status'];?></td>
                      <td>
                        <a href="<?= base_url; ?>/user/edit/<?= $row['iduser'] ?>" class="badge badge-info ">Edit</a> <a href="<?= base_url; ?>/user/hapus/<?= $row['iduser'] ?>" class="badge badge-danger" onclick="return confirm('Hapus data?');">Hapus</a>
                      </td>
                    </tr>
                    <?php $no++; endforeach; ?>
                  </tbody>
