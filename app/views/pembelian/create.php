              ...
              <form role="form" action="<?= base_url; ?>/pembelian/simpanpembelian" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="masukkan jumlah pembelian..." name="jumlah">
                  </div>
                  <div class="form-group">
                    <label >Harga Beli</label>
                    <input type="numeric" class="form-control" placeholder="masukkan harga beli barang..." name="harga">
                  </div>
                <!-- /.card-body -->
                <div class="form-group">
                    <label >Barang</label>
